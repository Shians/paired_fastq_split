...
```
usage: fastq_split.py [-h] -file1 FILE1 -file2 FILE2 -barcodes BARCODES
...
```
fastq_split.py -file1 exp_R1.fastq.gz -file2 exp_R2.fastq.gz -barcodes barcodes.txt -prefix exp
```
